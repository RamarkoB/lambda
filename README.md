...
This is a drag-and-drop calculator for Untyped Lambda Calculus (UML) with built in visualization of
[Tromp Diagrams](https://tromp.github.io/cl/diagrams.html). This roject was inspire by the
[2swap video on Lambda Calculus](https://www.youtube.com/watch?v=RcVA8Nj6HEo), as well as my time in the University of Chicago Programming
Languages Class. The lambda calculator currently supports four reduction strategies:
