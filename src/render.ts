import { Application, Term, TermType } from "./types";
import { fmtTerm } from "./utils";
  ...
  switch (term.type) {
    ...
    case TermType.Abstraction: {
      ...
      if (showNames && term.name) {
        ...
        const newLayers = renderTerm(newGroup, term.body, horLayers, newVerTopLayer, verBottomLayer, newValues, config);
    ...
    case TermType.Application: {
      ...
      const funcLayers = renderTerm(funcGroup, term.func, horLayers, verTopLayer, newVerBottomLayer, values, config);
      ...
      const horArgLayers = renderTerm(argGroup, term.arg, newHorLayer, verTopLayer, newVerBottomLayer, values, config);
...
export { renderGroup, HOR_GAP, HOR_OFFSET, VER_GAP, VER_OFFSET, defaultConfig };
